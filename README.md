...
- [7.数据库管理](#7数据库管理)（默认未安装，需要打开注释）
    - [7.1 phpRedisAdmin](#72-phpredisadmin)
...
2. `clone`项目：
    ```
    $ git clone https://git.dev.tencent.com/junang/dnmp.git
    ```
...
## 7.数据库管理（在docker-compose.yml中打开注释重新运行一次即可）
### 7.1 phpRedisAdmin
